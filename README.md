...
- 3 个工程通识大类：19 个核心章 / 51 个节点、18 个可选进阶章 / 54 个节点，以及 10 章 / 30 节点的 Agent 前沿路线；
- 软件与系统工程、软件质量与生产交付、AI 应用与 Agent 的核心/进阶双层地图；
- 15 题起点诊断、12 周最小路线、每周复盘与中断恢复；
- 6 个端到端案例和 6 套可复制架构/交付模板；
- 版本化权威来源目录；不同专题独立记录检索截止日、核验日、用途和外推边界；
- 独立 Agent 前沿路线：当前证据检索截止 2026-09-03，一手论文、正式规范和系统卡分别记录方法、证据、局限与工程边界；
- 机器学习、深度学习、NLP、AI 产品经理、低空智能、机器人六条深研路线：共规划 240 个独立主题 / 页面；当前 48 篇达到正式内容契约，另 192 篇仍是待逐阶段重写和人工审阅的草稿；
- 正式章节按主题选择故事、机制、公式、图表、实验和反例，不以固定栏目或二级标题数量冒充内容密度；
...
├── fields/                240 个规划节点：48 篇正式内容，192 篇待重写草稿
