...
export const domains: Domain[] = [
  ...
  },
  {
    ...
    count: 19,
    chapters: [
      { text: "01 · 模型、Token、Context 与不确定性", link: "/domains/ai/01-models", ids: ["AI01", "AI02"] },
      { text: "02 · 结构化输出、Prompt 与上下文工程", link: "/domains/ai/02-context", ids: ["AI03", "AI04"] },
      { text: "03 · Embedding、RAG 与检索评测", link: "/domains/ai/03-rag", ids: ["AI05", "AI06", "AI07", "AI08"] },
      { text: "04 · Tool Calling、权限与 MCP", link: "/domains/ai/04-tools-mcp", ids: ["AI09", "AI10", "AI11"] },
      { text: "05 · 工作流、Agent Runtime 与记忆", link: "/domains/ai/05-agent-runtime", ids: ["AI12", "AI13", "AI14"] },
      { text: "06 · Trace、评测、安全与生产治理", link: "/domains/ai/06-evals-safety", ids: ["AI15", "AI16", "AI17", "AI18", "AI19"] },
    ],
  },
];
...
export function domainSidebar(key: Domain["key"]) {
  ...
  return [
    ...
    { text: `${domain.count} 个知识节点`, items: domain.chapters.map(({ text, link }) => ({ text, link })) },
  ];
}
